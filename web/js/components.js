...
function render(root){
  ...
  try {
    ...
    root.replaceChildren(el('div', { class: 'card' }, el('h2', {}, 'Error'), el('p', {}, e.message)))
  }
...
function createAllocBar(parent, container){
  ...
  const nextBtn = el('button', { class: 'btn-action', title: 'Assign the next free subnet without listing the whole pool' }, 'Assign next')
